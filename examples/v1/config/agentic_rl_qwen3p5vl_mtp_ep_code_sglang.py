...
rollout_context_length = int(os.environ.get("ROLLOUT_CONTEXT_LENGTH", max_prompt_length + max_response_length))
rollout_tensor_parallel_size = int(os.environ.get("ROLLOUT_TENSOR_PARALLEL_SIZE", 2))
...
rollout_config = RolloutConfig(
    ...
    context_length=rollout_context_length,
