...
enable_sglang_prefix_cache = os.environ.get("ENABLE_SGLANG_PREFIX_CACHE", "true").lower() in (
    "1",
    "true",
    "yes",
    "on",
)
sglang_prefix_cache_schedule_policy = os.environ.get("SGLANG_PREFIX_CACHE_SCHEDULE_POLICY", "lpm")
...
rollout_config = RolloutConfig(
    ...
    extra_rollout_config=dict(
        ...
        sglang_disable_radix_cache=not enable_sglang_prefix_cache,
        sglang_schedule_policy=sglang_prefix_cache_schedule_policy if enable_sglang_prefix_cache else "fcfs",
