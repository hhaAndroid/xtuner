...
class ModelArguments:
    ...
    ps_version: str = field(
        default='v2',
        metadata={'help': 'Specify the version of pixel shuffle implementation. '
...
class DataTrainingArguments:
    ...
    conv_style: Optional[str] = field(
        default='phi3-chat', metadata={'help': 'Prompt style for a conversation.'}
    )
...
def main():
    ...
    logger.warning(
        f'{dist.get_rank()} Process rank: {training_args.local_rank}, device: {training_args.device}, n_gpu: {training_args.n_gpu}'
    ...
    # Just for the convenience of writing code
    ...
    if model_args.model_name_or_path is not None:
        ...
        internvl_chat_config = InternVLChatConfig(
            vision_config, llm_config, downsample_ratio=data_args.down_sample_ratio,
    ...
    logger.warning(f'{dist.get_rank()} =================Start training============')
