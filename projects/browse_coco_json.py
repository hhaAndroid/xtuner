...
def parse_args():
    ...
    parser.add_argument('--data-root', default='/home/PJLAB/huanghaian/dataset/coco', help='dataset root')
    parser.add_argument(
        '--img-dir', default='/home/PJLAB/huanghaian/dataset/coco/train2017', help='image folder path')
    parser.add_argument(
        '--ann-file',
