...
export PYTHONPATH="${SGLANG_REPO}/python:${SGLANG_REPO}:${pwd}"
export WORK_DIR='work_dirs_rl/qwen3vl_8b_grpo_mixdata3-sglang'
...
bash examples/v1/scripts/run_rl.sh examples/v1/config/reasoning_rl_qwen3p5vl_mtp_ep_sglang.py "sglang" $QWEN3P5_VL_MODEL_PATH $META_DATA_PATH
