...
export WORK_DIR="work_dirs/qwen35b/sft_all_local_256k_lixin_replacemodel"
...
CONFIG_PATH="/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/configs/sft_qwen35vl_35b_lixin.py"
