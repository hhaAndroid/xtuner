...
export WORK_DIR="work_dirs/qwen35b/sft_all_ceph"
export META_DATA_PATH="/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/meta_data/interns1_1_base02_20260120b_tiny.json"
export TOKENIZER_CACHE_DIR='workspace/qwen35ba3_local/sft_tokenizer_cache'
CONFIG_PATH="/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/configs/sft_qwen35vl_35b_config.py"
