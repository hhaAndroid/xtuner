...
# export META_DATA_PATH="/mnt/shared-storage-user/huanghaian/code/xtuner/local_meta.json"
...
export WORK_DIR="work_dir/internvl3.5-dataloader"
...
python ci/scripts/test_dataloader_time.py $CONFIG_PATH  2>&1 | tee -a "${WORK_DIR}/training_log_${current_time}.txt"
