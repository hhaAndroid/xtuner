...
script=${2:-"/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/job_sh/run_agentic_rl.sh"}
...
export CLUSTERX_CFG_PATH=/mnt/shared-storage-user/huanghaian/clusterx_dev.yaml
