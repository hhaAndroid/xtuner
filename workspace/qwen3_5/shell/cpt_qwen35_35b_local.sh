...
# sft
export WORK_DIR="work_dirs_local/qwen35b_mem_debug/sft_all_local"
...
export META_DATA_PATH="/mnt/shared-storage-user/huanghaian/code/temp/xtuner/workspace/qwen3_5/meta_data/vlm_pretrain_ci_data.json"
...
CONFIG_PATH="/mnt/shared-storage-user/huanghaian/code/temp/xtuner/workspace/qwen3_5/configs/cpt_qwen35vl_35b_config.py"
