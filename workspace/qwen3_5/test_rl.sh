...
export WORK_DIR='work_dirs11/qwen3_30b_grpo_gsm8k'
...
bash examples/v1/scripts/run_rl.sh examples/v1/config/rl_grpo_geo3k_judge.py "lmdeploy" $QWEN3VL_MODEL_PATH $ROLLOUT_DATA_PATH $ROLLOUT_TEST_DATA_PATH
