...
export WORK_DIR='work_dirs_rl/qwen3vl_8b_grpo_gsm8k_1'
...
# bash examples/v1/scripts/run_rl_submit.sh examples/v1/config/rl_qwen3p5_vl_35B_grpo_mixdata.py "lmdeploy" $QWEN3P5_VL_MODEL_PATH $META_DATA_PATH $EVAL_DATA_PATH
