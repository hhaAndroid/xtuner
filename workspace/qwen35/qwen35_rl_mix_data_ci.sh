...
export WORK_DIR='work_dirs_rl/qwen3vl_8b_grpo_mixdata111'
...
# bash examples/v1/scripts/run_rl.sh examples/v1/config/rl_qwen3p5_vl_35B_grpo_mixdata.py "lmdeploy" $QWEN3P5_VL_MODEL_PATH $META_DATA_PATH
bash examples/v1/scripts/run_rl.sh autotest/config/rl_qwen3p5_vl_35B_grpo.py "lmdeploy" $QWEN3P5_VL_MODEL_PATH $META_DATA_PATH
