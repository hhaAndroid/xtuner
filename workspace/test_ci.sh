...
export QWEN3_5_MOE_PATH='/mnt/shared-storage-user/gpfs2-shared-public/huggingface/hub/models--Qwen--Qwen3.5-35B-A3B/snapshots/ec2d4ece1ffb563322cbee9a48fe0e3fcbce0307'

export INTERNS1_DATA_META='/mnt/shared-storage-user/llmrazor-share/data/vlm_ci_data.json'
export GEO3K_LONGTAIL_DATA_PATH='/mnt/shared-storage-user/llmrazor-share/data/geometry3k/geometry3k_longtail_96.jsonl'
...
pytest tests/model/test_qwen3_5.py
# pytest /mnt/shared-storage-user/huanghaian/code/xtuner/tests/model/test_mimo_dense.py