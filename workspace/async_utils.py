...
def asyncio_run(coro: Coroutine, loop: Optional[AbstractEventLoop] = None) -> Any:
    ...
    watchdog = None
    try:
        from xtuner.v1.utils.asyncio_diagnostics import install_asyncio_diagnostics, start_asyncio_run_watchdog

        install_asyncio_diagnostics(loop)
    ...
    try:
        ...
        try:
            from xtuner.v1.utils.asyncio_diagnostics import stop_asyncio_run_watchdog
