...
meta_data_path = '/mnt/shared-storage-user/huanghaian/code/temp/xtuner/workspace/local_meta_2.json'
model_path = "  - /mnt/shared-storage-user/large-model-center-share-weights/shai_lab/internvl_s1_share/InternVL3_5-8B-CPT-HF/" # 转换后的权重（hf官方格式）
work_dir = "./work_dirs/demo_internvl3.5_sft_ml_32k_tokenizer"
tokenizer_cache_dir = "./work_dirs/internvl3.5"
