...
export WORK_DIR="work_dirs_qwen3/interns1_1_g1_sft"
export PYTHONPATH="$(pwd)"
export XTUNER_GC_ENABLE=1

CONFIG_PATH="/mnt/shared-storage-user/huanghaian/code/temp/xtuner/examples/v1/cpt_interns1_1_g1_config.py"
