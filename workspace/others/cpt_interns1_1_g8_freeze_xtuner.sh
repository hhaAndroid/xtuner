...
export WORK_DIR="/mnt/shared-storage-user/llmrazor-share/huanghaian/work_dirs_qwen3_profile/interns1_1_g8_freeze"
export PYTHONPATH="/mnt/shared-storage-user/huanghaian/code/GroupedGEMM_ccy:$(pwd)"
export XTUNER_GC_ENABLE=1
# export CUDA_LAUNCH_BLOCKING=1

CONFIG_PATH="examples/v1/cpt_interns1_1_g8_config_freeze.py"
