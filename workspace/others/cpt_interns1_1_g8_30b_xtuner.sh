...
export WORK_DIR="/mnt/shared-storage-user/llmrazor-share/huanghaian/work_dirs_qwen3_profile/interns1_1_g8_30b_cpt"
export PYTHONPATH="$(pwd)"
export XTUNER_GC_ENABLE=1

CONFIG_PATH="examples/v1/cpt_interns1_1_g8_30b_config.py"
