...
ceph_config = None
# meta_data_path = '/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/meta_data/interns1_1_base02_20260120b_tiny_local.json'
meta_data_path = '/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/meta_data/interns1_1_base02_20260120b_tiny_debug.keep_video.json'
# meta_data_path = '/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/meta_data/interns1_1_base02_20260120b_tiny_local_text.json'
# meta_data_path = '/mnt/shared-storage-user/huanghaian/code/xtuner/workspace/meta_data/llava.json'
tokenizer_cache_dir ='workspace/qwen35ba3_local/sft_tokenizer_cache'
...
global_batch_size = 8
total_epoch = 1
hf_interval = 4000000000
hf_max_keep = 10
checkpoint_interval = 4000000000
...
model_cfg.vision_config.depth = 2
model_cfg.text_config.num_hidden_layers=2
model_cfg.text_config.max_window_layers=2
...
dataloader_config = DataloaderConfig(
    ...
    tokenizer_hash='8c9069141267900a',
)
