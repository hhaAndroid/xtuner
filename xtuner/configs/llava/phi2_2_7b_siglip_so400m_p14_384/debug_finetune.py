...
pretrained_pth = 'work_dirs/debug_pretrain/iter_2181.pth'
...
llava_dataset = dict(
    ...
    template_map_fn=dict(
        type=template_map_fn_factory, template=prompt_template, pretrain=False),  # xxxx
...
train_dataloader = dict(
    ...
    sampler=dict(
        ...
        per_device_batch_size=batch_size),  # xxxxx
    collate_fn=dict(type=mm_collate_fn, pad_index=50256)) # xxxxx
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type=optim_type, lr=lr, betas=betas, weight_decay=weight_decay, eps=1e-7),  # xxxxx
...
val_dataloader = dict(
    ...
    collate_fn=dict(type=mm_collate_fn, pad_index=50256, extra_collate_keys=['img_id']))
val_evaluator = dict()
